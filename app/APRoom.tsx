    ...
    return (
        <ImageBackground
            ...
            <ScrollView style={styles.ProfilePageContainer} >
                ...
                {/*********************************************** */}
                <View style={styles.row}>
                    {seatState.slice(78, 84).map((seat) => (
                        <TouchableOpacity
                            key={seat.id}
                            style={[
                                styles.seat,
                ...
                <View style={styles.row}>
                    {seatState.slice(72, 78).map((seat) => (
                        <TouchableOpacity
                            key={seat.id}
                            style={[
                                styles.seat,
                ...
                {/*********************************************** */}
                <View style={styles.row}>
                    {seatState.slice(66, 72).map((seat) => (
                        <TouchableOpacity
                            key={seat.id}
                            style={[
                                styles.seat,
                ...
                <View style={styles.row}>
                    {seatState.slice(60, 66).map((seat) => (
                        <TouchableOpacity
                            key={seat.id}
                            style={[
                                styles.seat,
                ...
                {/*********************************************** */}
                <View style={styles.row}>
                    {seatState.slice(54, 60).map((seat) => (
                        <TouchableOpacity
                            key={seat.id}
                            style={[
                                styles.seat,
                ...
                <View style={styles.row}>
                    {seatState.slice(48, 54).map((seat) => (
                        <TouchableOpacity
                            key={seat.id}
                            style={[
                                styles.seat,
                ...
                {/*********************************************** */}
                <View style={styles.row}>
                    {seatState.slice(42, 48).map((seat) => (
                        <TouchableOpacity
                            key={seat.id}
                            style={[
                                styles.seat,
                ...
                <View style={styles.row}>
                    {seatState.slice(36, 42).map((seat) => (
                        <TouchableOpacity
                            key={seat.id}
                            style={[
                                styles.seat,
                ...
                {/*********************************************** */}
                <View style={styles.row}>
                    {seatState.slice(30, 36).map((seat) => (
                        <TouchableOpacity
                            key={seat.id}
                            style={[
                                styles.seat,
                ...
                <View style={styles.row}>
                    {seatState.slice(24, 30).map((seat) => (
                        <TouchableOpacity
                            key={seat.id}
                            style={[
                                styles.seat,
                ...
                {/*********************************************** */}
                <View style={styles.row}>
                    {seatState.slice(18, 24).map((seat) => (
                        <TouchableOpacity
                            key={seat.id}
                            style={[
                                styles.seat,
                ...
                <View style={styles.row}>
                    {seatState.slice(12, 18).map((seat) => (
                        <TouchableOpacity
                            key={seat.id}
                            style={[
                                styles.seat,
