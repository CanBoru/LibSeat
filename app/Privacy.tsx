...
import { ScrollView, StyleSheet, Text, View, Button, Alert, ImageBackground } from 'react-native';
    ...
    return (
        ...
        <ImageBackground source={require("../assets/images/page_background_v1.png")}
            ...
            <ScrollView style={styles.container}>
                ...
                <Text style={styles.listItem}>1. To maintain an accurate record of visits.</Text>
