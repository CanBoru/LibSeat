...
export default function QZRoom() {
    ...
    useEffect(() => {
        ...
        const fetchSeats = async () => {
            axios.post('http://192.168.1.49:3000/LibSeat/getSeats', { roomName: 'Q-Z Room' })
                .then(response => {
        ...
        const fechSelectedSeat = async () => {
            try {
                ...
                if (userData.seatId && userData.roomName === "Q-Z Room") {
    ...
    const handleSeatPress = (seatId: number) => {
        ...
        if (reservedSeat === seatId) {
            ...
            navigation.navigate('UserSeat', { seatId: seatId, roomName: 'Q-Z Room' });
        }
        ...
        if (selectedSeatId !== null) {
            ...
            axios.put('http://192.168.1.49:3000/LibSeat/allocateSeat', {
                ...
                .then(response => {
                    ...
                    navigation.navigate('UserSeat', { seatId: selectedSeatId, roomName: 'Q-Z Room' })
                })
                .catch(error => {
